...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Subatix in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Subatix and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
